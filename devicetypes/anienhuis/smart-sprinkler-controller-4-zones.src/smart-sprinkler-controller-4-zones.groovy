...
metadata {
    definition (name: "Smart Sprinkler Controller 4 Zones", version: "1.0.3", author: "aaron.nienhuis@gmail.com", namespace: "anienhuis", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
